...
class D3D12TriangleTestApplication final
{
public:
    bool Initialize()
    {
...
private:
    bool CreateNativeDeviceAndSwapChain()
    {
        ...
        HApp::ZWConsoleLogger::PrintProperty("Adapter", HTest::WideToUtf8(adapterDesc.Description));
    ...
    bool CreatePipeline()
    {
        ...
        const HTest::fs::path vertexShaderPath = shaderDirectory / "triangle_vs.cso";
        const HTest::fs::path pixelShaderPath = shaderDirectory / "triangle_ps.cso";
...
{
    D3D12TriangleTestApplication application;
